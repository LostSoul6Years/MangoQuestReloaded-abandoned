...
public class CustomObjectManager
{
	...
	public static void loadCustomObjects() {
		for (Class<? extends CustomQuestObject> obj : objectList) {
			...
			QuestChatManager.logCmd(Level.INFO, I18n.locMsg(null,"CustomObject.ObjectRegistered", obj.getName()));
		}
	}
	...
	public static CustomQuestObject getSpecificObject(String className) {
		try {
			...
			QuestChatManager.logCmd(Level.SEVERE, I18n.locMsg(null,"CustomObject.ObjectNotFound", className));
			e.printStackTrace();
			return null;
		}
	}
