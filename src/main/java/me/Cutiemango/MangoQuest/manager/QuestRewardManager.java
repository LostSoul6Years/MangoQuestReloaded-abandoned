...
public class QuestRewardManager implements Listener
{
	...
	public static String getItemName(ItemStack item) {
		if (item == null)
			...
			return QuestChatManager.translateColor(QuestUtil.getItemName(item) + " &f" + ChatColor
	...
	public static void giveRewardItem(Player p, ItemStack is) {
		if (p.getInventory().firstEmpty() == -1) {
			...
			QuestChatManager.info(p, I18n.locMsg(p,"QuestReward.GiveItemReward", QuestUtil.getItemName(is), Integer.toString(is.getAmount())));
