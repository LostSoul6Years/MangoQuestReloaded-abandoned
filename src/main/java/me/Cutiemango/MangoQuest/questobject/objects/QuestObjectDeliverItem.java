...
public String toDisplayText(Player p) {
		return I18n.locMsg(p,"QuestObject.DeliverItem", Integer.toString(amount), QuestUtil.getItemName(p, item), me.Cutiemango.MangoQuest.compatutils.Minecraft.MinecraftCompatability.getName(npc));
	}
