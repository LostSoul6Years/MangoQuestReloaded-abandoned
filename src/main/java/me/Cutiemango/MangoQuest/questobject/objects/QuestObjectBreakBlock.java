...
public String toDisplayText(Player p) {
		return I18n.locMsg(p,"QuestObject.BreakBlock", Integer.toString(amount), QuestUtil.translate(p, block), "");
	}
	...
	public void formatEditorPage(Player p,FlexibleBook page, int stage, int obj) {
		page.add(I18n.locMsg(null,"QuestEditor.BreakBlock") + QuestUtil.translate(p, block));
