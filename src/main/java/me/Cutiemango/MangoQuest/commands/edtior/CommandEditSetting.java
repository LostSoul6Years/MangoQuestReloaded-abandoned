...
public class CommandEditSetting
{
	...
	private static void editWorld(Quest q, Player sender, String[] args) {
		if (args.length == 3) {
			EditorListenerHandler.register(sender,
					new EditorListenerObject(ListeningType.STRING, "mq e edit world", Syntax.of("W", I18n.locMsg(sender,"Syntax.World"), "")));
			QuestBookGUIManager.openInfo(sender, I18n.locMsg(sender,"EditorMessage.EnterValue"));
		} else if (args.length == 4) {
	...
	private static void editTimeLimit(Quest q, Player sender, String[] args) {
		if (args.length == 3) {
			EditorListenerHandler.register(sender,
					new EditorListenerObject(ListeningType.STRING, "mq e edit timelimit", Syntax.of("I", I18n.locMsg(sender,"Syntax.Number"), "")));
			QuestBookGUIManager.openInfo(sender, I18n.locMsg(sender,"EditorMessage.EnterValue"));
		} else if (args.length == 4) {
	...
	private static void editRedo(Quest q, Player sender, String[] args) {
		if (args.length == 3) {
			...
			QuestBookGUIManager.openInfo(sender, I18n.locMsg(sender,"EditorMessage.RedoSetting"));
		} else if (args.length == 4) {
	...
	private static void editRedoDelay(Quest q, Player sender, String[] args) {
		if (args.length == 3) {
			EditorListenerHandler.register(sender,
					new EditorListenerObject(ListeningType.STRING, "mq e edit redodelay", Syntax.of("I", I18n.locMsg(sender,"Syntax.Number"), "")));
			QuestBookGUIManager.openInfo(sender, I18n.locMsg(sender,"EditorMessage.EnterValue"));
		} else if (args.length == 4) {
	...
	private static void editResetHour(Quest q, Player sender, String[] args) {
		if (args.length == 3) {
			EditorListenerHandler.register(sender,
					new EditorListenerObject(ListeningType.STRING, "mq e edit resethour", Syntax.of("I", I18n.locMsg(sender,"Syntax.Hour"), "")));
			QuestBookGUIManager.openInfo(sender, I18n.locMsg(sender,"EditorMessage.EnterValue"));
		} else if (args.length == 4) {
	...
	private static void editResetDay(Quest q, Player sender, String[] args) {
		if (args.length == 3) {
			EditorListenerHandler.register(sender,
					new EditorListenerObject(ListeningType.STRING, "mq e edit resetday", Syntax.of("I", I18n.locMsg(sender,"Syntax.Day"), "")));
			QuestBookGUIManager.openInfo(sender, I18n.locMsg(sender,"EditorMessage.EnterValue"));
		} else if (args.length == 4) {
