...
public class Version_v1_16_R1 implements VersionHandler
{
	...
	public String getItemTypeTranslationKey(Material material) {
        ...
        net.minecraft.server.v1_16_R1.Item nmsItem = org.bukkit.craftbukkit.v1_16_R1.util.CraftMagicNumbers.getItem(material);
	...
	public void openBook(Player p, TextComponent... texts)
	{
		...
		CraftMetaBook meta = (CraftMetaBook)book.getItemMeta();		try {
			Field f = null;
	...
	public TextComponent textFactoryConvertLocation(Player p,String name, Location loc, boolean isFinished)
	{
		...
		//ItemTag itemTag = ItemTag.ofNbt(CraftItemStack.asNMSCopy(is).getTag().asString());
		   ...
		   BaseComponent[] hoverEventComponents = new BaseComponent[]{
		            new TextComponent(CraftItemStack.asNMSCopy(is).getTag().asString()) // The only element of the hover events basecomponents is the item json
		    };
