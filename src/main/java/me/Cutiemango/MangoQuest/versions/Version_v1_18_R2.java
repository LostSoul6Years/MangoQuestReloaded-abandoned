...
public class Version_v1_18_R2 implements VersionHandler {
	...
	public ItemStack addGUITag(ItemStack item) {
		...
		NBTTagCompound stag = ((boolean)StupidReflection.callMethodWithObjectArgs(nmscopy,"u").isEmpty())? ((NBTTagCompound)StupidReflection.callMethodWithObjectArgs(nmscopy,"s").get()): new NBTTagCompound();
	...
	public boolean hasGUITag(ItemStack item) {
		net.minecraft.world.item.ItemStack  nmscopy = CraftItemStack.asNMSCopy(item);
		NBTTagCompound tag = ((boolean)StupidReflection.callMethodWithObjectArgs(nmscopy,"u").isEmpty())? ((NBTTagCompound)StupidReflection.callMethodWithObjectArgs(nmscopy,"s").get()): new NBTTagCompound();
		//same
