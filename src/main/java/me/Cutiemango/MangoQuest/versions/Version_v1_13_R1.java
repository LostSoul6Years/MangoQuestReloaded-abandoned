...
public class Version_v1_13_R1 implements VersionHandler
{
	...
	public String getItemTypeTranslationKey(Material material) {
        ...
        net.minecraft.server.v1_13_R1.Item nmsItem = org.bukkit.craftbukkit.v1_13_R1.util.CraftMagicNumbers.getItem(material);
	...
	@Override
	public TextComponent textFactoryConvertItem(Player p,ItemStack item, boolean finished)
	{
	...
	{
		net.minecraft.server.v1_13_R1.ItemStack nmscopy = CraftItemStack.asNMSCopy(item);
