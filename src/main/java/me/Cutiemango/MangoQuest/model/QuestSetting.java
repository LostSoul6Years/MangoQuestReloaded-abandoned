...
public class QuestSetting
{
	...
	// FailMessage
	protected String failRequirementMessage = I18n.locMsg(null,"Requirements.NotMeet.Default");

	// Redo & Quit
	//	protected boolean isRedoable = false;
	protected boolean isQuitable = true;
	protected String quitAcceptMsg = I18n.locMsg(null,"QuestQuitMsg.DefaultQuit");
	protected String quitCancelMsg = I18n.locMsg(null,"QuestQuitMsg.DefaultCancel");
	protected String quitDenyMsg = I18n.locMsg(null,"QuestQuitMsg.Denied");
	...
	{
		DAILY("QuestEditor.RedoSetting.Daily"),
		WEEKLY("QuestEditor.RedoSetting.Weekly"),
		COOLDOWN("QuestEditor.RedoSetting.Cooldown"),
		ONCE_ONLY("QuestEditor.RedoSetting.OnceOnly");
