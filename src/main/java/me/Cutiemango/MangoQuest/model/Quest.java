...
public class Quest
{
			...
			if (!requirements.containsKey(t)) {
				switch (t) {
					...
					case LEVEL:
						...
						requirements.put(RequirementType.LEVEL, null);
						break;
					case MONEY:
						//requirements.put(RequirementType.MONEY, 0d);
						requirements.put(RequirementType.MONEY, null);
						break;
					case PERMISSION:
					...
					case PLACEHOLDER_API:
						requirements.put(t, new HashMap<String,String>());
						break;
					case SERVER_TIME:
					case WORLD_TIME:
						requirements.put(t, new ArrayList<Long>());
						break;
					case MCMMO_LEVEL:
						requirements.put(t, new HashMap<PrimarySkillType,Integer>());
						break;
				}
	...
	public String getQuitAcceptMsg(Player p) {
		return (setting.quitAcceptMsg == null) ? I18n.locMsg(p,"QuestQuitMsg.DefaultQuit") : setting.quitAcceptMsg;
	}
	...
	public String getQuitCancelMsg(Player p) {
		return (setting.quitCancelMsg == null) ? I18n.locMsg(p,"QuestQuitMsg.DefaultCancel") : setting.quitCancelMsg;
	}
	...
	public static void synchronizeLocal(Quest q) {
		...
		QuestUtil.recompileEffectsWithQuestName(q.getInternalID());
	}
