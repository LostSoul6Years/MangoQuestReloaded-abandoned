...
public class TextComponentFactory
{
	...
	public static TextComponent convertItemHoverEvent(Player p,ItemStack it, boolean isFinished) {
		DebugHandler.log(5, "converted Items (call) ");
		return Main.getInstance().handler.textFactoryConvertItem(p,it, isFinished);
	}
